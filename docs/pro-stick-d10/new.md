...
* Im unten stehenden Beispiel ist das EZCast Pro Gerät `DIRECT-Pro 2 D10_BF19D098` mit der WLAN-Infrastruktur `stueber-demo-5ghz` mit guter Signalstärke über das# WLAN-Umgebung scannen
...
![](/assets/img/wifi.test.2.png)
 ...
 Kanal 36 (5Ghz-Frequenz) verbunden:
